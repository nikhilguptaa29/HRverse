...
class _ReportsPageState extends State<ReportsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      attendanceProvider.loadAvailableMonths();
    });
  }
          ...
          children: [
            Padding(
              ...
              child: DropdownButton(
                value:
                    attendanceProvider.selectedMonth.isNotEmpty
                        ? attendanceProvider.selectedMonth
                        : null,
                items:
                    attendanceProvider.dropdownMonths.map((month) {
                      return DropdownMenuItem(value: month, child: Text(month));
                    }).toList(),
                onChanged: (value) {
                  if (value != null) {
                    attendanceProvider.upateSelectedMonth(value);
                  }
                },
              ),
            ),
